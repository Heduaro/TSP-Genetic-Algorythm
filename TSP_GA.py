...
def distance(city1,city2):
    ...
    #fitness function calculates the sum of products between each input
...
# usecols is supposed to provide a filter before reading the whole DataFrame into memory
    ...
    df = pd.read_csv(r'stany.csv', usecols=fields, skiprows=[2, 9])
    ...
    tsp.to_csv('tsp_stany_solution.csv', index=False)
